...
def test_full_outer_join_look_back_eq_1(spark: SparkSession):
    ...
    expected = spark.createDataFrame(
        [
            ...
            Row(TrxId=2, RecDate=date(2025, 3, 4), RecDate_A=None, RecDate_B=date(2025, 3, 4), DiffArrivalTime=None, JoinType="not_matched"),
            ...
            Row(TrxId=5, RecDate=date(2025, 3, 12), RecDate_A=None, RecDate_B=date(2025, 3, 12), DiffArrivalTime=None, JoinType="not_matched"),
            Row(TrxId=6, RecDate=date(2025, 3, 7), RecDate_A=date(2025, 3, 7), RecDate_B=None, DiffArrivalTime=None, JoinType="a_timed_out"),
            Row(TrxId=6, RecDate=date(2025, 3, 18), RecDate_A=None, RecDate_B=date(2025, 3, 18), DiffArrivalTime=None, JoinType="not_matched"),
            Row(TrxId=7, RecDate=date(2025, 3, 8), RecDate_A=date(2025, 3, 8), RecDate_B=None, DiffArrivalTime=None, JoinType="a_timed_out"),
            Row(TrxId=7, RecDate=date(2025, 3, 6), RecDate_A=None, RecDate_B=date(2025, 3, 6), DiffArrivalTime=None, JoinType="not_matched"),
        ],
...
def test_full_outer_join_no_enforce_sliding_window(spark: SparkSession):
...
def test_full_outer_join_timed_out_rows(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_small_output_window(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_6(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_7(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_8(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_9(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_10(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_11(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_12(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_march_13(spark: SparkSession):
    df_a, df_b = create_example_data(spark)
...
def test_full_outer_join_include_waiting_records(spark: SparkSession):
...
def test_full_outer_join_waiting_vs_timed_out_records(spark: SparkSession):
    ...
    expected = spark.createDataFrame(
        [
            ...
            Row(TrxId=6, RecDate=date(2025, 3, 18), RecDate_A=None, RecDate_B=date(2025, 3, 18), DiffArrivalTime=None, WaitingTime=None, JoinType="not_matched"),
            Row(TrxId=7, RecDate=date(2025, 3, 8), RecDate_A=date(2025, 3, 8), RecDate_B=date(2025, 3, 6), DiffArrivalTime=-2, WaitingTime=None, JoinType="a_late"),
        ],
        schema=JOIN_RESULT_SCHEMA_WITH_WAITING,
    )
